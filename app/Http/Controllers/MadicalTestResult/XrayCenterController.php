...
class XrayCenterController extends Controller
{
    ...
    public function Send_request(Request $request)
    {
        ...
        $UserRequest = new XrayCenterRequest();
    ...
    return $this->returnError('#E100',' البريد الالكتروني مستخدم مسبقا');
        ...
        return $this->returnError('#E100',' الرجاء ادخال صورة ترخيص مركز الاشعة');
    }
    ...
    public function profile(Request $request)
    {
        ...
        if ($auth_check) {
            ...
            return $this->returnData('Xray Center', $user);
        } else {
